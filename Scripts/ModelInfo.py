...
if __name__ == "__main__":
    model = cobra.io.sbml.read_sbml_model("C:/Users/maria/Documents/GitHub/merlinv4_paper/Models/AuReMe/models/aureme_model3.xml")
    get_reactions_to_convert(model)
    model = cobra.io.sbml.read_sbml_model("C:/Users/maria/Documents/GitHub/merlinv4_paper/Models/CarveMe/models/model_carveme.xml")
    get_reactions_to_convert(model)
    model = cobra.io.sbml.read_sbml_model("C:/Users/maria/Documents/GitHub/merlinv4_paper/Models/KBase/model/kbase_model.xml")
    get_reactions_to_convert(model)
    model = cobra.io.sbml.read_sbml_model("C:/Users/maria/Documents/GitHub/merlinv4_paper/Models/Merlin-BA/merlin_model.xml")
    get_reactions_to_convert(model)
    model = cobra.io.sbml.read_sbml_model("C:/Users/maria/Documents/GitHub/merlinv4_paper/Models/Merlin-BIT/BIT_model.xml")
    get_reactions_to_convert(model)